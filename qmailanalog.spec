...
Summary(pl):	Zestaw narzêdzi pomagaj±cych w analizie rekordu aktywno¶ci qmaila
Name:		qmailanalog
Version:	0.70
Release:	0.5
Epoch:		0
...
%description -l pl
Zestaw narzêdzi pomagaj±cych w analizie rekordu aktywno¶ci qmaila.

qmailanalog zawiera tak¿e kilka narzêdzi skupiaj±cych uwagê na
szczególnych nadawców, odbiorców lub wiadomo¶ciach.

Ten pakiet zawiera tak¿e tai64nfrac, który po otrzymaniu danych ze
znacznikami czasu TAI64N (takich jak dane wygenerowane przez
multiloga), przekonwertuje te znaczniki na sekundy od epoki (z czê¶ci±
u³amkow±) - a w przypadku innych danych zwróci te same dane.
...
%doc MATCHUP ACCOUNTING BLURB README THANKS TODO
