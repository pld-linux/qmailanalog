...
Zestaw narzędzi pomagających w analizie rekordu aktywności qmaila.

qmailanalog zawiera także kilka narzędzi skupiających uwagę na
szczególnych nadawców, odbiorców lub wiadomościach.

Ten pakiet zawiera także tai64nfrac, który po otrzymaniu danych ze
znacznikami czasu TAI64N (takich jak dane wygenerowane przez
multiloga), przekonwertuje te znaczniki na sekundy od epoki (z częścią
ułamkową) - a w przypadku innych danych zwróci te same dane.
